...
[#2](https://github.com/KristijanIvanoski/github-stats/issues/2),
[#3](https://github.com/KristijanIvanoski/github-stats/issues/3), and
[#13](https://github.com/KristijanIvanoski/github-stats/issues/13).
...
1. Create a personal access token (not the default GitHub Actions token) using
   ...
   - Some users are reporting that it can take a few minutes for the personal
     ...
     [#30](https://github.com/KristijanIvanoski/github-stats/issues/30).
2. Click [here](https://github.com/KristijanIvanoski/github-stats/generate) to create a
...
5. It is possible to change the type of statistics reported.
   - To ignore certain repos, add them (in owner/name format e.g.,
     `KristijanIvanoski/github-stats`) separated by commas to a new secret—created as
   ...
   - To show statistics only for "owned" repositories and not forks with
     ...
     [main
     workflow](https://github.com/KristijanIvanoski/github-stats/blob/master/.github/workflows/main.yml))
